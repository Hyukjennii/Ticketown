...
<br><br><br>
<article>
<h2>${qnaVO.qseq }번 "${qnaVO.subject }" 게시물 수정하기</h2>
<form name="formm" method="post"	action="movie.do">
	<input type="hidden" name="command" value="qnaRevise">
	<fieldset>
	<div class="control-group board_write_category">
	    ...
	    <label>제목</label><br/><input type="text" name="subject"  size="60" value="${qnaVO.subject }"><br>
		<label>내용</label><br/><textarea rows="24%" cols="120%" name="content">${qnaVO.content }</textarea>
	...
	<div id="buttons" style="float:right">
		...
		<%-- onclick="location.href='movie.do?command=qnaRevise&qseq=${qnaVO.qseq }'"> --%>
		<input type="reset"   value="취소"     class="cancel">
		<input type="button"  value="Q&A로 돌아가기"  class="submit"  
		onclick="location.href='movie.do?command=qnaList'">
	</div>
</form>
</article>
